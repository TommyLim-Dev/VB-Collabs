...
Public Class Form1
    ...
    Private Sub bsimpan_Click(sender As Object, e As EventArgs) Handles bsimpan.Click
        ...
        Else
            Call Koneksi()
            Cmd = New OleDb.OleDbCommand("select * From data where NIM = '" & txtnim.Text & "'", conn)
    ...
    Private Sub bedit_Click(sender As Object, e As EventArgs) Handles bedit.Click
        ...
        Else
            Call Koneksi()
            Cmd = New OleDb.OleDbCommand("update data set Nama= '" & txtnama.Text & "', Jurusan='" & cmbjurusan.Text & "', Alamat= '" & txtalamat.Text & "'where NIM='" & txtnim.Text & "'", conn)
            Cmd.ExecuteNonQuery()
    ...
    Private Sub bhapus_Click(sender As Object, e As EventArgs) Handles bhapus.Click
        ...
        Else
            Call Koneksi()
            Cmd = New OleDb.OleDbCommand("delete from data where NIM='" & txtnim.Text & "'", conn)
            Cmd.ExecuteNonQuery()
